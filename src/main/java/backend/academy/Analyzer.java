...
public class Analyzer {
    ...
    public static void main(String[] args) {
        ...
        logAnalyzer.analyzeLogs(argsParser.getPath(), argsParser.getFrom(), argsParser.getTo(), argsParser.getFilterField(), argsParser.getFilterValue());
        TextReport report;
        if (argsParser.getFormat().equals("adoc")) {
